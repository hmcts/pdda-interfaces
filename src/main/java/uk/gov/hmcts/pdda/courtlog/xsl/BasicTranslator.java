...
public class BasicTranslator extends Translator {
     ...
     */
    private void formatDateAndTime(final Locale locale, final Document input,
        ...
        final String displayDate =
            DateFormat.getDateInstance(DateFormat.SHORT, locale).format(entryDate);
        final String displayTime =
            DateFormat.getTimeInstance(DateFormat.SHORT, locale).format(entryDate);

        xmlServices.addElementByTagName(input, CourtLogCrudValue.ENTRY_DATE, displayDate,
            XML_TAG_COURT_LOG_EVENT);
        xmlServices.addElementByTagName(input, CourtLogCrudValue.ENTRY_TIME, displayTime,
            XML_TAG_COURT_LOG_EVENT);
    }
     ...
     * 
     * @param input The document to transform
     * 
     * @param xslFileName the transformation to apply
     * 
     * @return The transformed document as a string
     * 
     * @throws EDSException if anything fails.
     */
