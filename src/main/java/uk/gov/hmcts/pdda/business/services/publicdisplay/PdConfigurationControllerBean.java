...
public class PdConfigurationControllerBean extends PublicDisplayControllerBean implements
    Serializable {
  ...
  public DisplayRotationSetData[] getCourtConfiguration(final Integer courtId) {
    ...
    synchronized (this) {
      ...
      return getDisplayRotationSetDataHelper().getDataForCourt(court.get(),
          getXhbDisplayRepository(),
          getXhbRotationSetsRepository(), getXhbRotationSetDdRepository(),
  ...
  public DisplayRotationSetData[] getUpdatedRotationSet(final int courtId,
    ...
    if (rotationSet.isPresent()) {
      ...
      List<XhbDisplayDao> xhbDisplays = getXhbDisplayRepository().findByRotationSetId(
          rotationSetId);
  ...
  public DisplayRotationSetData[] getUpdatedDisplay(final int courtId, final int displayId) {
    ...
    if (display.isPresent()) {
      ...
      if (rotationSet.isPresent()) {
        displayRotationSetData = getDisplayRotationSetDataHelper().getDisplayRotationSetData(
            court.get(),
  ...
  public RotationSetComplexValue getRotationSet(final Integer rotationSetId) {
    ...
    List<XhbRotationSetDdDao> rotationSetDdCol = getXhbRotationSetDdRepository().findByRotationSetId(
        rotationSetId);
    ...
    while (rotationSetDdIter.hasNext()) {
      ...
      XhbDisplayDocumentDao xhbDisplayDocumentDao =
          xhbDisplayDocument.isPresent() ? xhbDisplayDocument.get() :
              null;
  ...
  /**
   * Requests courtrooms assigned to the VIP screen for a court house If none are found, falls back
   * to returning all court rooms.
   *
   * @param courtId the court house
   * @return array of XhbCourtRoomDAO
   */
  ...
  protected RotationSetDdComplexValue getRotationSetDdComplexValue(
      XhbRotationSetDdDao rotationSetDdDao,
