...
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (7, 'POLL_INTERVAL', '30000000');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (8, 'CHECK_POLL_INTERVAL', '60000000');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (4, 'TIME_DELAY_EXISS_SEND', '10');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (5, 'EXISS_MAX_RETRY', '5');
...
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (2, 'MAX_SMTP_SEND_ATTEMPTS', '5');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (3, 'MAX_MAPI_SEND_ATTEMPTS', '5');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (10, 'LAA_TRIAL', '/var/mqsi/LAA/outbound/TRS/');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (11, 'LAA_COMMITTAL', '/var/mqsi/LAA/outbound/SRS/');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (12, 'LAA_APPEAL', '/var/mqsi/LAA/outbound/ARS/');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (9, 'Overnight RefreshTimeDelay', '2');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (27, 'BATCH_CASES_ALLOWED_TO_DELETE', '1');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (51, 'COURTEL_COURT_MOLD', 'MOLDC');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (59, 'CPPX_SchemaWP', 'CPPX_InternetWebPage-v1-0.xsd');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (60, 'CPPX_SchemaPD', 'CPPX_PublicDisplay-v1-0.xsd');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (61, 'CPPX_SchemaDL', 'DailyList-v1-0.xsd');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (62, 'CPPX_SchemaFL', 'FirmList-v1-0.xsd');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (63, 'CPPX_SchemaWL', 'WarnedList-v1-0.xsd');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (64, 'STAGING_DOCS_TO_PROCESS', '3');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (58, 'FORMATTING_LIST_DELAY', '900');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (28, 'MESSAGE_LOOKUP_DELAY', '60');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
...
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (66, 'DARTS_DVR_RELEASE_DATE', '23/09/2022');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (13, 'COURTEL_TIMEOUT', '60');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (14, 'COURTEL_LIST_AMOUNT', '1');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (15, 'COURTEL_KEY_MANAGER_PASSWORD', 'External637');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (16, 'COURTEL_TRUST_MANAGER_PASSWORD', 'courteltrust');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (17, 'COURTEL_SERVER_1', 'https://www.courtel-rxdev.net/xhibitinterfaceauth/xhibitlib/upload.php');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (18, 'COURTEL_SERVER_2', 'https://www.courtel-rxdev.net/xhibitinterfaceauth/xhibitlib/upload.php');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (19, 'COURTEL_CGI_PROXY', '10.24.1.253');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (20, 'COURTEL_CGI_PROXY_PORT', '8080');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (21, 'COURTEL_FILE_PATH', '/opt/moj/bea/user_projects/domains/XHIBIT_PREPROD/tmp');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (22, 'COURTEL_KEY_MANAGER_JKS', '/opt/moj/bea/user_projects/domains/XHIBIT_PREPROD/common/security/courtel.jks');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (23, 'COURTEL_TRUST_MANAGER_JKS', '/opt/moj/bea/user_projects/domains/XHIBIT_PREPROD/common/security/courteltrust');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (24, 'COURTEL_USERNAME', 'cgi-nle');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (25, 'COURTEL_PASSWORD', 'summer#match');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (26, 'COURTEL_MAX_RETRY', '5');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (52, 'XHB_HK_NO_OF_YEARS', '7');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (53, 'XHB_HK_NO_OF_DAYS_TO_HOUSEKEEP', '30');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (54, 'XHB_HK_NO_OF_DAYS_LISTS_RETAINED_AFTER_CASE_DEALT', '180');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (55, 'XHB_HK_NO_OF_DAYS_COURTEL_LISTS_RETAINED_AFTER_CASE_DEALT', '180');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (65, 'MERGE_CUT_OFF_TIME', '18:30:00');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (67, 'DARTS_COURTLOG_DELAY', '50');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (56, 'XHB_HK_NO_OF_DAYS_BEFORE_LIST_MARKED_AS_OBSOLETE', '180');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (57, 'XHB_HK_NO_OF_DAYS_BEFORE_A_LIST_IS_DELETED', '730');
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
...
Insert into XHB_CONFIG_PROP
   (CONFIG_PROP_ID, PROPERTY_NAME, PROPERTY_VALUE)
 Values
   (89, 'USE_KEY_VAULT_PROPERTIES', 'false');
COMMIT;
