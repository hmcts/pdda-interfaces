insert into xhb_ref_cracked_effective (REF_CRACKED_EFFECTIVE_ID,CODE,DESCRIPTION,PARTY_RESPONSIBLE,OBS_IND,LAST_UPDATE_DATE,CREATION_DATE,LAST_UPDATED_BY,CREATED_BY,VERSION,TRIAL_CODE_TYPE) values (
