...
class CathUtilsTest {
    ...
    private static final String WARNED_LIST_XML =
        "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\r\n" + "<cs:WarnedList\r\n"
            + "    xmlns:cs=\"http://www.courtservice.gov.uk/schemas/courtservice\"\r\n"
            + "    xmlns:p2=\"http://www.govtalk.gov.uk/people/bs7666\"\r\n"
            + "    xmlns:apd=\"http://www.govtalk.gov.uk/people/AddressAndPersonalDetails\">\r\n"
            + "    <cs:DocumentID>\r\n"
            + "        <cs:DocumentName>WarnedList_457_20240614152950.xml</cs:DocumentName>\r\n"
            + "        <cs:UniqueID>5313bacb-2743-404a-b4ac-7f9c010ee2c5</cs:UniqueID>\r\n"
            + "        <cs:DocumentType>WL</cs:DocumentType>\r\n" + "    </cs:DocumentID>\r\n"
            + "    <cs:ListHeader>\r\n" + "        <cs:ListCategory>Criminal</cs:ListCategory>\r\n"
            + "        <cs:StartDate>2025-12-22</cs:StartDate>\r\n"
            + "        <cs:EndDate>2025-12-28</cs:EndDate>\r\n"
            + "        <cs:Version>NOT VERSIONED</cs:Version>\r\n"
            + "        <cs:PublishedTime>2024-06-14T12:07:23.733Z</cs:PublishedTime>\r\n"
            + "    </cs:ListHeader>\r\n" + "    <cs:CrownCourt>\r\n"
            + "        <cs:CourtHouseName>SWANSEA</cs:CourtHouseName>\r\n"
            + "        <cs:CourtHouseAddress>\r\n" + "            <cs:Line>TEST</cs:Line>\r\n"
            + "            <cs:Postcode>TEST</cs:Postcode>\r\n"
            + "        </cs:CourtHouseAddress>\r\n"
            + "        <CourtHouseTelephone>TEST</CourtHouseTelephone>\r\n"
            + "        <CourtHouseFax>TEST</CourtHouseFax>\r\n"
            + "        <Description>TEST</Description>\r\n" + "    </cs:CrownCourt>\r\n"
            + "    <ListingInstruction>TEST</ListingInstruction>\r\n" + "    <cs:CourtLists>\r\n"
            + "        <cs:CourtList>\r\n" + "            <cs:CourtHouse>\r\n"
            ...
            + "                <Description>TEST</Description>\r\n"
            + "            </cs:CourtHouse>\r\n"
            + "            <cs:WithFixedDate HearingType=\"PLE\">\r\n"
            + "                <cs:Fixture>\r\n"
            + "                    <cs:FixedDate>2025-12-25</cs:FixedDate>\r\n"
            + "                    <cs:Notes>TEST</cs:Notes>\r\n"
            + "                    <cs:Cases>\r\n" + "                        <cs:Case>\r\n"
            + "                            <cs:CaseNumber>CPP</cs:CaseNumber>\r\n"
            + "                            <cs:Hearing HearingType=\"PLE\">\r\n"
            + "                                <cs:HearingDate>2025-12-25</cs:HearingDate>\r\n"
            + "                                <cs:HearingEndDate>TEST</cs:HearingEndDate>\r\n"
            + "                                <cs:ListNote>Section 49 of the Children and Young"
            + " Persons Act 1933 applies</cs:ListNote>\r\n"
            + "                                <cs:HearingType>TEST</cs:HearingType>\r\n"
            + "                            </cs:Hearing>\r\n"
            + "                            <cs:Defendants>\r\n"
            + "                                <cs:Defendant>\r\n"
            + "                                    <cs:PersonalDetails>\r\n"
            + "                                        <apd:CitizenNameForename>check</apd:CitizenNameForename>\r\n"
            + "                                        <apd:CitizenNameSurname>data</apd:CitizenNameSurname>\r\n"
            + "                                        <apd:CitizenNameRequestedName>check data"
            + "                                        </apd:CitizenNameRequestedName>\r\n"
            + "                                        <cs:IsMasked>no</cs:IsMasked>\r\n"
            + "                                    </cs:PersonalDetails>\r\n"
            + "                                    <CustodyStatus>TEST</CustodyStatus>\r\n"
            + "                                    <Counsel>\r\n"
            + "                                        <Solicitor>\r\n"
            + "                                            <Party>\r\n"
            + "                                                <Organisation>\r\n"
            ...
            + "                                    </Counsel>\r\n"
            + "                                    <cs:Charges>\r\n"
            + "                                        <cs:Charge IndictmentCountNumber=\"0\" CJSoffenceCode="
            + "\"TH68023\">\r\n"
            + "                                            <cs:CRN>TEST</cs:CRN>\r\n"
            + "                                            <cs:CRESTchargeID>TEST</cs:CRESTchargeID>\r\n"
            + "                                            <cs:CaseNumber>TEST</cs:CaseNumber>\r\n"
            + "                                            <cs:OffenceStatement>Robbery</cs:OffenceStatement>\r\n"
            + "                                            <cs:OffenceLocation>\r\n"
            + "                                                <cs:Line>TEST</cs:Line>\r\n"
            + "                                                <cs:Postcode>TEST</cs:Postcode>\r\n"
            + "                                            </cs:OffenceLocation>\r\n"
            ...
            + "                                            <cs:ChargeType>TEST</cs:ChargeType>\r\n"
            + "                                            <cs:IndictmentNumber>TEST</cs:IndictmentNumber>\r\n"
            + "                                            <cs:IndictmentCountNumber>TEST"
            + "                                            </cs:IndictmentCountNumber>\r\n"
            + "                                            <cs:CJSoffenceCode>TEST</cs:CJSoffenceCode>\r\n"
            + "                                            <cs:PNCoffencecode>TEST</cs:PNCoffencecode>\r\n"
            + "                                            <cs:HOoffencecode>TEST</cs:HOoffencecode>\r\n"
            + "                                            <cs:Life>TEST</cs:Life>\r\n"
            ...
            + "                                        </cs:Charge>\r\n"
            + "                                    </cs:Charges>\r\n"
            + "                                    <cs:NumberOfCharges>TEST</cs:NumberOfCharges>\r\n"
            + "                                    <cs:OriginalCharges>\r\n"
            + "                                        <cs:OriginalChargeSequenceNumber>TEST"
            + "                                        </cs:OriginalChargeSequenceNumber>\r\n"
            + "                                        <cs:OriginalChargeDescription>TEST"
            + "                                        </cs:OriginalChargeDescription>\r\n"
            + "                                    </cs:OriginalCharges>\r\n"
            + "                                    <cs:AdditionalNotes>TEST</cs:AdditionalNotes>\r\n"
            + "                                </cs:Defendant>\r\n"
            + "                            </cs:Defendants>\r\n"
            ...
            + "                                </cs:ProsecutingOrganisation>\r\n"
            + "                            </cs:Prosecution>\r\n"
            + "                            <cs:AppealCaseDescription>TEST</cs:AppealCaseDescription>\r\n"
            + "                        </cs:Case>\r\n" + "                    </cs:Cases>\r\n"
            + "                </cs:Fixture>\r\n" + "            </cs:WithFixedDate>\r\n"
            + "            <cs:WithoutFixedDate HearingType=\"PLE\">\r\n"
            + "                <cs:Fixture>\r\n"
            + "                    <cs:FixedDate>2025-12-25</cs:FixedDate>\r\n"
            + "                    <cs:Notes>TEST</cs:Notes>\r\n"
            + "                    <cs:Cases>\r\n" + "                        <cs:Case>\r\n"
            ...
            + "                                    </Counsel>\r\n"
            + "                                    <cs:Charges>\r\n"
            + "                                        <cs:Charge IndictmentCountNumber=\"0\" "
    ...
    @Test
    void testGenerateDailyListJsonFromString() {
    ...
    @Test
    void testGenerateWarnedListJsonFromString() {
        JSONObject result = CathUtils.generateJsonFromString(WARNED_LIST_XML);
        String jsonAsString = result.toString(4); // This indentation value of 4 matches the indentation of the xml
        assertNotNull(jsonAsString, NOTNULL);
    }
}
